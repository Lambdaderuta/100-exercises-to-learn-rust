...
impl WeekTemperatures {
    pub fn new() -> Self {
        Self {
            temp_by_days: Default::default()
        }
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        self.temp_by_days[<Weekday as Into<usize>>::into(day)]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        self.temp_by_days[<Weekday as Into<usize>>::into(day)] = Some(temperature)
    }
}
